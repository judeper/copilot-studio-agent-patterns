...
|----------|-------------|------------|
| [Intelligent Work Layer](enterprise-work-assistant/) | Intelligent work layer that intercepts email, Teams, and calendar signals — triaging, researching, and preparing draft responses autonomously via a MARL pipeline with 17 agent prompts, learning from user behavior across 9 Dataverse tables, and rendering results on a PCF React dashboard with WCAG AA compliance. Design docs cover architecture, learning, and UX enhancements. | Copilot Studio agent (17 prompts), Power Automate flows, Dataverse (9 tables with learning system), PCF React dashboard, Canvas app, OneNote (optional) |
