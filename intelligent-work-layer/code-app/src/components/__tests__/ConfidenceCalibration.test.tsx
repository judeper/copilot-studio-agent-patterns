...
describe('ConfidenceCalibration', () => {
    ...
    describe('Top Senders tab', () => {
        it('shows sender engagement table', async () => {
            const cards = [
                makeCard({ original_sender_email: 'alice@example.com', original_sender_display: 'Alice', card_outcome: 'SENT_AS_IS' }),
                makeCard({ original_sender_email: 'alice@example.com', original_sender_display: 'Alice', card_outcome: 'DISMISSED' }),
                makeCard({ original_sender_email: 'bob@example.com', original_sender_display: 'Bob', card_outcome: 'SENT_EDITED' }),
            ];
            renderCalibration(cards);
