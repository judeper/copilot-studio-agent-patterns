...
.EXAMPLE
    .\user-data-erasure.ps1 -OrgUrl "https://myorg.crm.dynamics.com" -UserEmail "jane@contoso.com" -WhatIf

.EXAMPLE
    .\user-data-erasure.ps1 -OrgUrl "https://myorg.crm.dynamics.com" -UserEmail "jane@contoso.com" -Force
#>
