...
export const tier1SkipItem: AssistantCard = {
    ...
    original_sender_email: 'newsletter@example.com',
...
export const tier2LightItem: AssistantCard = {
    ...
    card_outcome: 'PENDING',
    original_sender_email: 'alee@example.com',
...
export const calendarBriefingItem: AssistantCard = {
    ...
    card_outcome: 'PENDING',
    original_sender_email: 'jsmith@example.com',
...
export const validJsonRecord: MockRecordData = {
    ...
    values: {
        ...
        createdon: null,
        cr_originalsenderemail: 'legal@example.com',
        ...
        cr_sourcesignalid: 'msgid-full-001@example.com',
    },
    formattedValues: {
