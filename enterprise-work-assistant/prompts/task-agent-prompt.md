...
```json
{
  ...
  "task_list": [
    { "task_id": "task-001", "title": "Finalize Q3 budget proposal", "due_date": "2026-03-03T17:00:00Z", "status": "in_progress", "assigned_to": ["user@contoso.com"] },
    { "task_id": "task-002", "title": "Submit compliance report", "due_date": "2026-03-04T17:00:00Z", "status": "not_started", "assigned_to": ["user@contoso.com"] },
    { "task_id": "task-003", "title": "Review vendor proposals", "due_date": "2026-03-05T17:00:00Z", "status": "not_started", "assigned_to": ["user@contoso.com"] },
    { "task_id": "task-004", "title": "Update project timeline", "due_date": "2026-03-07T17:00:00Z", "status": "not_started", "assigned_to": ["user@contoso.com"] }
  ]
}
```
