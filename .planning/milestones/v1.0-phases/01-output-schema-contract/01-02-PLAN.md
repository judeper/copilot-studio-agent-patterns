...
files_modified:
  ...
  - intelligent-work-layer/prompts/humanizer-agent-prompt.md
autonomous: true
requirements:
  - SCHM-01
  - SCHM-03
...
must_haves:
  ...
  artifacts:
    ...
    - path: "intelligent-work-layer/prompts/humanizer-agent-prompt.md"
      provides: "Humanizer agent prompt with draft_type in input contract"
      contains: "draft_type"
  key_links:
    - from: "intelligent-work-layer/prompts/main-agent-system-prompt.md"
      to: "intelligent-work-layer/schemas/output-schema.json"
      via: "JSON examples and output schema template match the canonical schema"
      pattern: "item_summary.*summary"
    - from: "intelligent-work-layer/prompts/humanizer-agent-prompt.md"
      to: "intelligent-work-layer/schemas/output-schema.json"
...
<task type="auto">
  ...
  <files>intelligent-work-layer/prompts/main-agent-system-prompt.md</files>
  <action>
