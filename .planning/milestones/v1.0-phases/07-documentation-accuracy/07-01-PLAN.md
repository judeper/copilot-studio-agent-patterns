...
must_haves:
  ...
  key_links:
    - from: "intelligent-work-layer/docs/deployment-guide.md"
      to: "intelligent-work-layer/docs/agent-flows.md"
...
Output: Updated `intelligent-work-layer/docs/deployment-guide.md`
</objective>
...
<task type="auto">
  ...
  <files>intelligent-work-layer/docs/deployment-guide.md</files>
  <action>
