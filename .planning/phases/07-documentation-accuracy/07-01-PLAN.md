...
9. Section 2.4 contains "Last verified: Feb 2026"
  ...
  <done>
Deployment guide has accurate JSON output configuration instructions using function-first language, prerequisites specify Node.js >= 20 and Bun >= 1.x with platform-specific install commands grouped by category, and research tool section has a freshness date.
  </done>
</task>
