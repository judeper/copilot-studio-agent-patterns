...
must_haves:
  ...
  artifacts:
    - path: "intelligent-work-layer/schemas/output-schema.json"
      ...
      contains: "N/A"
    - path: "intelligent-work-layer/prompts/main-agent-system-prompt.md"
    ...
    - path: "intelligent-work-layer/prompts/daily-briefing-agent-prompt.md"
      provides: "Prompt injection defense"
      contains: "OPEN_CARDS"
    - path: "intelligent-work-layer/scripts/create-security-roles.ps1"
...
<task type="auto">
  ...
  <verify>
    <automated>grep -c '"N/A"' intelligent-work-layer/schemas/output-schema.json | grep -q '[2-9]' && echo "PASS: N/A in schema" || echo "FAIL"; grep -c "USER_OVERRIDE" intelligent-work-layer/prompts/main-agent-system-prompt.md | grep -q '[1-9]' && echo "PASS: USER_OVERRIDE" || echo "FAIL"; grep -c "USER_VIP" intelligent-work-layer/prompts/main-agent-system-prompt.md | grep -q '^0$' && echo "PASS: no USER_VIP" || echo "FAIL"; grep -l "untrusted" intelligent-work-layer/prompts/main-agent-system-prompt.md intelligent-work-layer/prompts/orchestrator-agent-prompt.md intelligent-work-layer/prompts/daily-briefing-agent-prompt.md | wc -l | grep -q '3' && echo "PASS: injection defense in all 3" || echo "FAIL"</automated>
  </verify>
  <done>
...
<task type="auto">
  ...
  <verify>
    <automated>grep -c "AssistantCard" intelligent-work-layer/scripts/create-security-roles.ps1 | grep -q '[1-9]' && echo "PASS: PascalCase" || echo "FAIL"; grep -c "publisher" intelligent-work-layer/scripts/provision-environment.ps1 | grep -q '[1-9]' && echo "PASS: publisher" || echo "FAIL"; grep -c "cr_dismisscount\|cr_avgeditdistance\|cr_avgresponsehours\|cr_responsecount" intelligent-work-layer/scripts/provision-environment.ps1 | grep -q '[4-9]' && echo "PASS: Sprint 4 columns" || echo "FAIL"; grep -c "dataset" intelligent-work-layer/src/AssistantDashboard/hooks/useCardData.ts | grep -q '[1-9]' && echo "PASS: dataset dep" || echo "FAIL"</automated>
  </verify>
  <done>
