...
- But wait — the `from` field format varies by trigger version (per Session 2, Issue 8). The raw `from` string might be `"Sarah Chen" <sarah@example.com>` or just `sarah@example.com`
