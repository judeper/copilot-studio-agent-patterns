...
$entitySchemaName = "${PublisherPrefix}_FollowUpTracking"
$privilegeNames = @(
...
# IMPORTANT: Dataverse privileges use the entity SchemaName (PascalCase), not LogicalName (lowercase)
$nudgeSchemaName = "${PublisherPrefix}_NudgeConfiguration"
$nudgePrivilegeNames = @(
    "prvCreate${nudgeSchemaName}",
    "prvRead${nudgeSchemaName}",
    "prvWrite${nudgeSchemaName}",
    "prvDelete${nudgeSchemaName}",
    "prvAppend${nudgeSchemaName}",
    "prvAppendTo${nudgeSchemaName}"
)
...
# IMPORTANT: Dataverse privileges use the entity SchemaName (PascalCase), not LogicalName (lowercase)
$snoozedSchemaName = "${PublisherPrefix}_SnoozedConversation"
...
try {
    ...
    $snoozedPrivilegeNames = @(
        "prvCreate${snoozedSchemaName}",
        "prvRead${snoozedSchemaName}",
        "prvWrite${snoozedSchemaName}",
        "prvDelete${snoozedSchemaName}",
        "prvAppend${snoozedSchemaName}",
        "prvAppendTo${snoozedSchemaName}"
    )
